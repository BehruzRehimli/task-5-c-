...
namespace dersde6task
{
    internal class Program
    {
        ...
        //Task 4 - Verilmiş email-lər siyahısından domainlər siyahısı düzəldən metod.Domainlər arrayondə
        // təkrarlanmamlıdır domainlər!

        {
            string[] newstr= new string[str.Length];
            for (int i = 0; i < str.Length; i++)
            {
                newstr[i] = str[i].Substring(str[i].IndexOf('@')+1);
            }

            return DontRepeat(newstr);
        }
